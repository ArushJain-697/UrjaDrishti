export const translations = {
  en: {
    ...
    solar: "Solar",
    wind: "Wind",
    urjaDrishtiWordmark: "URJADRISHTI",
    orgWordmark: "KREDL / KSPDCL",
    errorPrefix: "ERR",
    loadFailed: "Load failed",
    toggleTheme: "Toggle Theme",
    notificationSettings: "Notification Settings",
    enterWarRoomTitle: "Enter War Room — fullscreen grid monitor",
  ...
  kn: {
    ...
    solar: "ಸೌರ",
    wind: "ಗಾಳಿ",
    urjaDrishtiWordmark: "ಊರ್ಜಾದೃಷ್ಟಿ",
    orgWordmark: "ಕೆಆರ್‌ಇಡಿಎಲ್ / ಕೆಎಸ್‌ಪಿಡಿಸಿಎಲ್",
    errorPrefix: "ದೋಷ",
    loadFailed: "ಲೋಡ್ ವಿಫಲವಾಗಿದೆ",
    toggleTheme: "ಥೀಮ್ ಬದಲಿಸಿ",
    notificationSettings: "ಅಧಿಸೂಚನೆ ಸೆಟ್ಟಿಂಗ್‌ಗಳು",
    enterWarRoomTitle: "ವಾರ್ ರೂಮ್‌ಗೆ ಪ್ರವೇಶಿಸಿ — ಪೂರ್ಣ ಪರದೆ ಗ್ರಿಡ್ ಮಾನಿಟರ್",
